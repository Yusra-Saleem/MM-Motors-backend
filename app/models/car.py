...
class Car(Base, TimestampMixin):
    ...
    status: Mapped[CarStatus] = mapped_column(SAEnum(CarStatus, name="car_status"), nullable=False, default=CarStatus.available)
    mileage: Mapped[str] = mapped_column(String(100), nullable=False)
    transmission: Mapped[str] = mapped_column(String(100), nullable=False)
    ...
    featured_flag: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
